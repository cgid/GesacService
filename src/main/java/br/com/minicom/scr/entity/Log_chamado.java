...
public class Log_chamado implements Entity {
	private final String DB = "SisCentralRel";
	private final String TABLENAME = "Log_chamado";
	private final String[] COLUMNNAMES = {"id_log_chamado", "operacao", "chamado_id_chamado", "duracao"};
	...
	public void setLogChamado(int logChamado) {
		this.values[0].setValue(logChamado);
	}
	...
	public void setDuracao(String duracao) {
		this.values[3].setValue(duracao);
	}
