...
public class Log_servico implements Entity {
	private final String DB = "SisCentralRel";
	private final String TABLENAME = "Log_servico";
	private final String[] COLUMNNAMES = {"id_log_servico", "operacao", "servico_id_servico"};
	...
	public void setLogServico(int logServico) {
		this.values[0].setValue(logServico);
	}
