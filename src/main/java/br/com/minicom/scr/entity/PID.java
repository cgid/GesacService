...
public class PID implements Entity {
	...
	private final String[] COLUMNNAMES = {"cod_pid", "cod_gesac", "cod_tc", "cod_cd", "cod_crc", "nome_estabelecimento"};
	...
	public void setCodCrc(int codCrc) {
		this.values[4].setValue(codCrc);
	}
	public void setNomeEstabelecimento(String nomeEstabelecimento) {
		this.values[5].setValue(nomeEstabelecimento);
	}
